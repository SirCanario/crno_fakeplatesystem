print("^9---------------------------------------------------^0")
print("^6Canario Shop | Fake Plate System^0")
...
if Config.Command ~= false then
    ...
    RegisterCommand(Config.Command, function(source)
        ...
        if not Config.Item.useItem then
            ...
            TriggerClientEvent('crno_fakeplatesystem:changePlate', source)
        ...
        elseif Config.Item.useItem and not Config.Item.usableItem then
            ...
            if xPlayer.getInventoryItem(Config.Item.item).count > 0 then
                ...
                TriggerClientEvent('crno_fakeplatesystem:changePlate', source, Config.Item.removeItem)
...
RegisterNetEvent('crno_fakeplatesystem:removeItem', function()
...
ESX.RegisterServerCallback('crno_fakeplatesystem:updatePlate', function(source, cb, oldPlate, newPlate)
    ...
    if Config.DataBaseChange then
        ...
        if not plateExists then
            ...
            TriggerClientEvent('crno_fakeplatesystem:updatePlate', -1, GetEntityCoords(GetPlayerPed(source)), oldPlate, newPlate)
